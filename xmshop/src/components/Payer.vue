        ...
        <div class="checkout-addr">
          ...
          <div class="order-foot-wrap">
            <div class="prev-btn-wrap">
              <router-link class="btn btn--m" to="/OrderConfirm"> 返回</router-link>
            </div>
            <div class="next-btn-wrap">
              <a class="btn btn--m btn--red" @click="realpay">下一步</a>
            </div>
          </div>

          <modal :mdShow="surepay">
            <span href="" slot="message">
                确定支付？
            </span>
            <div slot="btnGroup">
              <a href="javascript:;" class="btn btn--m" @click="surepay = false">更换付款方式</a>
              <router-link href="javascript:;" class="btn btn--m"
                           :to="{path:'OrderSuccess',query:{'orderId':this.orderId}}">支付
              </router-link>
            </div>
          </modal>
        </div>
