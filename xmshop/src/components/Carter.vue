<template>
  ...
  <div class="container">
            ...
            <li v-for="(item,index) in cartList" :key="index">
              <div class="cart-tab-1">
                <div class="cart-item-check">
                  <a  class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked}" @click="editCart('',item)">
        ...
        <div class="cart-foot-inner">
          ...
          <div class="cart-foot-r">
            <div class="item-total">
              总价: <span class="total-price" >{{totalPrice}}
            </span>
            </div>
            <div class="btn-wrap">
    ...
    <modal :mdShow="addressmoney">
      <p slot="message">请先选定商品，再去结账</p>
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn--m" @click="addressmoney = false">关闭</a>
      </div>
    </modal>
  </div>
</template>
      ...
      methods:{
        ...
        toggleCheckAll(){
          ...
          this.$http.post('/users/editCheckAll',{
            checkAll:this.checkAllFlag?true:false
          }).then((response) => {
